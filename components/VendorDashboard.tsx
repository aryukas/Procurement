...
import { User, ShipmentBid, BidStatus, BidOffer, Notification, VehicleDetails } from '../types';
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center space-x-1.5 text-slate-700">
                          ...
                          <span className="text-sm font-semibold">{new Date(bid.pickupTime).toLocaleDateString()}</span>
                        </div>
                      </div>
                      <div className="space-y-1">
        ...
        <div className="lg:w-1/3 space-y-6">
          {/* Action Context Card */}
          {selectedBid && (
            <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm animate-in fade-in slide-in-from-right-4 duration-300">
              <div className="flex justify-between items-start mb-6">
              ...
              {selectedBid.status === BidStatus.NEGOTIATING && selectedBid.winningVendorId === currentUser.id && (
                <div className="bg-blue-50 border border-blue-200 p-5 rounded-2xl space-y-4">
                  ...
                  <div className="flex space-x-3 pt-2">
                    <button 
                      onClick={() => {
                        onRespondToCounter(selectedBid.id, true);
                        setSelectedBid(null);
                      }}
                    ...
                    <button 
                      onClick={() => {
                        onRespondToCounter(selectedBid.id, false);
                        setSelectedBid(null);
                      }}
